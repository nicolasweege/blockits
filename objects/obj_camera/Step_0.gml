...
// assumindo que global.cam_target = obj_player
var yy = (global.cam_target.y - (sprite_get_height(PLAYER_COLLISION_MASK_SPRITE) / 2));

// isso aqui era usado pra definir os cantos da sprite do player como limite pra que a camera transicione 
// de um level pra outro, como a gente nao usa mais lerp pra fazer isso, e transicionamos direto, 
// esse codigo agora eh inutil.
/*
var xx = 0;
var yy = 0;
